...
angular.module('TruckMuncherApp').controller('vendorProfileCtrl', ['$scope', 'TruckService', 'growl', '$analytics',
    function($scope, TruckService: ITruckService, growl, $analytics) {
        $scope.trucks = [];
        $scope.selectedTruck = {};
        $scope.tags = [];
        ...
        $scope.saveTruck = function() {
            ...
            $analytics.eventTrack('TruckUpdated', {
        ...
        $scope.createTruck = function() {
            $scope.requestInProgress = true;
            TruckService.modifyTruckProfile(null, 'New Truck', [], null, null).then(function(response) {
                $scope.requestInProgress = false;
            ...
            $analytics.eventTrack('TruckCreated', {
                category: 'VendorProfile'
            });
        };
